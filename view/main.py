...
class AddDevice(QMainWindow):
    def __init__(self):
        ...
        self.menu_action1 = QAction(self)
        self.menu_action1.triggered.connect(self.homeUp)
        self.menu_action2 = QAction(self)
        self.menu_action2.triggered.connect(self.configureUp)
        self.menu_action3 = QAction(self)
        self.menu_action3.triggered.connect(self.addDeviceUp)
        self.menu_action4 = QAction(self)
        self.menu_action4.triggered.connect(self.deviceList)
        self.menu_action5 = QAction(self)
        self.menu_action5.triggered.connect(self.controlUP)
        self.HomeMenu.addAction(self.menu_action1)
        self.DeviceConfig.addAction(self.menu_action2)
        self.AddDeviceMenu.addAction(self.menu_action3)
